            ...
            <div class="card">
                <div class="card-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="content-login-id" name= "id" placeholder="ID">
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="contentLogin()">Login</button>
                </div>
            </div>
        </div>
        <div class="col-4"></div>
